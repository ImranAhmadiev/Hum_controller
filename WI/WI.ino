...
#define led_red 2//D4
constexpr auto pinSensor = 0;
const char* ssid = "Filyak";
const char* password = "12346789"; 
ESP8266WebServer server(80);
const int AirValue = 712;   //калибровка 
const int WaterValue = 275;  //калибровка
int hum; 
void setup() {
...
void handle_OnConnect() {
  ...
  int valueSensor = analogRead(pinSensor);
  hum = map(valueSensor, AirValue, WaterValue, 0, 100);
  server.send(200, "text/html", SendHTML(hum,hum));
}
